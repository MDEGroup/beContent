...
#$buffer = fread(fopen("bernardo.pdf","r"),filesize("bernardo.pdf"));
#$buffer = chunk_split(base64_encode($buffer));
	
	
#$mail = new zMail();

#$mail->addFrom("alfonso@di.univaq.it");
#$mail->addTo("alfonso@di.univaq.it");
#$mail->addSubject("This is a big test!");
#$mail->addMessage("just a short message");
#$mail->addAttachment("bernardo.pdf", "doc-1.pdf", "application/pdf");
#$mail->addAttachment("bernardo.pdf", "doc-2.pdf", "application/pdf");
#$mail->addAttachmentFromString($buffer, "doc-3.pdf", "application/pdf");
#$mail->send();
